...
highways_old = 'osmosis --read-xml 08132013_multnomah-SE.osm --tag-filter accept-ways highway=* --used-node --tag-filter reject-relations --write-xml 0813_highways.osm'

highways_new = 'osmosis --read-xml 08272013_multnomah-SE.osm --tag-filter accept-ways highway=* --used-node --tag-filter reject-relations --write-xml 0827_highways.osm'

change = 'osmosis --read-xml 0813_highways.osm --read-xml 0827_highways.osm --derive-change --write-xml-change 0813_to_0827_change.osm'
